...
<head>
    ...
    <title>Dashboard - Thông tin khách sạn</title>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><p style="font-size: 20px;color: white;font-family: 'Roboto Condensed', sans-serif;">Khách Sạn Xịn</p></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a  style="font-family: 'Roboto Condensed', sans-serif;" href="../admin/user/userlist.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Tạo Tài Khoản</a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a  style="font-family: 'Roboto Condensed', sans-serif;" href="../admin/user/chitietnhanvien.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Danh Sách Nhân Viên</a>
                    </li>
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Thông Báo: <span class="badge badge-danger hvr hvr-buzz" style="font-size: 18px" id="countCmtchuaduyet"></span> <a href="report.php" data-toggle="modal" data-target="#myModal">Tin Nhắn Từ Khách </a></h1>
                        <!-- The Modal -->
