		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="#" >
					...
					<div class="wrap-input100 validate-input" data-validate = "Hãy nhập tên đăng nhập của bạn" >
						<input class="input100" type="text" name="tendangnhap" placeholder="Nhập tên đăng nhập" id="tendangnhap">
					...
					<div class="wrap-input100 validate-input" data-validate = "Hãy nhập mật khẩu của bạn">
						<input class="input100" type="password" name="matkhau" placeholder="Nhập Mật Khẩu" id="matkhau" >
						<span class="focus-input100"></span>
						<span class="symbol-input100">
			...
			$.ajax({
				...
				success : function(data){
					if(data==1){
						...
						$("#modal-1").modal('show');
						setTimeout(function(){
							window.location="dangkyphong.php";
						},3000)
					}else{
