			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="#" >
					...
					<div class="wrap-input100 validate-input" data-validate = "Hãy nhập username của bạn" >
						<input class="input100" type="text" name="username" placeholder="Nhập Username" id="username">
					...
					<div class="wrap-input100 validate-input" data-validate = "Hãy nhập password của bạn">
						<input class="input100" type="password" name="password" placeholder="Nhập Password" id="password" >
						<span class="focus-input100"></span>
						<span class="symbol-input100">
